...
class UserSchoolsService {
    ...
    async checkExistingIds(Model, existingArray, field, errorMessage) {
        ...
        if (count !== existingIds.length) {
            throw new _http.NotFoundError(errorMessage);
        }
    }
    ...
    async getStudentSchoolsByUserId(userId) {
        return this.StudentSchool.scope(this.fullScope).findAll({
            where: { userId }
        });
    }
}
exports.default = UserSchoolsService;
//# sourceMappingURL=UserSchoolsService.js.map