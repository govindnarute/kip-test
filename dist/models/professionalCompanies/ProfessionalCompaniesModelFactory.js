...
exports.ProfessionalCompaniesModelFactory = undefined;
...
class ProfessionalCompaniesModelFactory {
    /**
    ...
    static define(sequelize) {
         ...
         */
        const ProfessionalCompany = sequelize.define('ProfessionalCompany', _ModelDefinitionBuilder.ModelDefinitionBuilder.properties({
        ...
        }), Object.assign(_ModelDefinitionBuilder.ModelDefinitionBuilder.options('professionalCompanies'), {
        ...
        ProfessionalCompany.associate = function () {
            this.belongsTo(sequelize.model('Company'), {
...
exports.ProfessionalCompaniesModelFactory = ProfessionalCompaniesModelFactory;
//# sourceMappingURL=ProfessionalCompaniesModelFactory.js.map