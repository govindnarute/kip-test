...
var _AutocompleteListDto = require('../models/autocomplete/AutocompleteListDto');
...
class AutocompleteController {
    ...
    async getLocations(request) {
        ...
        return new _AutocompleteListDto.AutocompleteListDto(list, _PaginationHelper.PaginationHelper.buildPagination(request.query, count));
    }
